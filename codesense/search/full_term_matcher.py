...
from codesense.config import PROJECT_OUTPUT_DIR
from codesense.embedding.embedding_main import score_pair
...
if __name__ == "__main__":
    ...
    sample = REPO_ROOT / "data" / "dsl_samples" / "extracted_results.json"
