...
from codesense.parsers import (
    DependencyItem,
    SymbolItem,
    parse_file_with_registry,
)
from codesense.parsers.registry import LANG_EXT
...
def main(argv=None):
    ...
    parser.add_argument("--project_path", default=str(cfg.project_path), help="项目根目录路径")
    parser.add_argument(
        "--output", default=str(cfg.project_output_dir), help="输出目录"
    )
